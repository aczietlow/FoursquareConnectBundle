<?php
namespace whatsup\FoursquareConnect\FoursquareConnect;

require_once 'FoursquareConnectInterface.php';
require_once 'config/appCredentials.php';


use whatsup\FoursquareConnectInterface as FSCI;


/**
* Base Class
*/
class FoursquareConnect implements FSCI\FourSquareConnectInterface {
